 ...
 * @maxItems 32
 */
export type ContradictingMemoryIds = NonEmptyString[];
/**
 * @maxItems 8
 */
...
export type MemoryType = "semantic";
 ...
 * @maxItems 32
 */
export type SupportingMemoryIds = NonEmptyString[];
export type Version = number;

export interface SemanticMemory {
  admission_score: UnitFloat;
  confidence: UnitFloat;
  contradicting_memory_ids?: ContradictingMemoryIds;
